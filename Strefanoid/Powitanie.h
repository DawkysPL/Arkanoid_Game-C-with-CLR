...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(275, 386);
			...
			this->pictureBox2->Location = System::Drawing::Point(275, 269);
			...
			this->Text = L"Gra typu Arkanoid - Witaj";
...
#pragma endregion
	private: System::Void pictureBox2_Click(System::Object^  sender, System::EventArgs^  e) {
		Plansza^ zagram = gcnew Plansza;
		zagram->Show();
		this->Close();
	}
	private: System::Void pictureBox1_Click(System::Object^  sender, System::EventArgs^  e) {
		Autor^ zagram = gcnew Autor;
		zagram->ShowDialog();
	}
	};
}
